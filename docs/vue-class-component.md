...
Documentation for currently installed version: <b>v6.3.2</b>
...
<template>
  <div>
    <input v-model="msg">
    <p class="mt-2">prop: {{propMessage}}</p>
    <p class="mt-2">msg: {{msg}}</p>
    <p class="mt-2">helloMsg: {{helloMsg}}</p>
    <p class="mt-2">computed msg: {{computedMsg}}</p>
